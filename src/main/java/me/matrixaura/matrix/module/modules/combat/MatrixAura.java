...
import me.matrixaura.matrix.core.concurrent.repeat.RepeatUnit;
...
import me.matrixaura.matrix.event.events.render.RenderModelEvent;
import me.matrixaura.matrix.mixin.mixins.accessor.AccessorCPacketPlayer;
import me.matrixaura.matrix.mixin.mixins.accessor.AccessorCPacketUseEntity;
import me.matrixaura.matrix.mixin.mixins.accessor.AccessorMinecraft;
...
import me.matrixaura.matrix.utils.*;
import me.matrixaura.matrix.utils.graphics.RenderUtils3D;
import me.matrixaura.matrix.utils.math.Pair;
...
import static me.matrixaura.matrix.core.concurrent.ConcurrentTaskManager.repeat;
import static me.matrixaura.matrix.core.concurrent.ConcurrentTaskManager.runRepeat;
import static me.matrixaura.matrix.utils.CrystalUtil.*;
...
@ModuleInfo(name = "MatrixAura", category = Category.COMBAT, description = "Place crystals to kill enemies")
public strictfp class MatrixAura extends Module {

    public static MatrixAura INSTANCE;
    ...
    Setting<Boolean> pauseWhileEating = setting("PauseWhileEating", false).whenAtMode(page, Page.Break).des("Pause MatrixAura while you are eating");
