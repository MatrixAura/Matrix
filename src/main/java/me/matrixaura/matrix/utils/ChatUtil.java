...
public class ChatUtil {
    ...
    public static void sendNoSpamMessage(String message, int messageID) {
        sendNoSpamRawChatMessage(SECTIONSIGN + "7[" + SECTIONSIGN + "b" + Matrix.MOD_NAME + SECTIONSIGN + "7] " + SECTIONSIGN + "r" + message, messageID);
    }

    public static void sendNoSpamMessage(String message) {
        sendNoSpamRawChatMessage(SECTIONSIGN + "7[" + SECTIONSIGN + "b" + Matrix.MOD_NAME + SECTIONSIGN + "7] " + SECTIONSIGN + "r" + message);
    }
    ...
    public static void printChatMessage(String message) {
        printRawChatMessage(SECTIONSIGN + "7[" + SECTIONSIGN + "b" + Matrix.MOD_NAME + SECTIONSIGN + "7] " + SECTIONSIGN + "r" + message);
    }
